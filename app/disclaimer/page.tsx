        ...
        <div className="space-y-8 text-sm leading-relaxed text-slate-700">
          <section>
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              当サービス「CognitiveLens」が提供する16タイプ診断・認知機能分析・対人関係アドバイス等のコンテンツは、心理学の理論をベースにした自己理解・エンターテインメント目的の参考情報として提供されるものです。
              コンテンツの正確性・完全性・科学的根拠を保証するものではなく、医療的診断・心理的診断・事業的判断・法的アドバイス等に代わるものではありません。
            </p>
            <p className="mt-3">
