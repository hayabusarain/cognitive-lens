...
{
  "trueRequest": "【本当に欲しかったもの】その言葉の奥にある、相手が本当に求めていた安心感や気持ちを、シンプルに言語化する。「〜って言ってるけど、本当は〜が欲しかっただけ」という形式で。感情の核心に触れること。2文以内。",
  "mineWords": "【やってはいけない返し方】受け取った側がついやりがちな「地雷返し」を具体的に挙げ、なぜそれが逆効果かを分かりやすく説明する。「〜って返すと、相手には〜に聞こえて、もっと傷つく」という形式で。2文以内。",
  "optimalReply": "【魔法の言葉】相手の心がほっと緩む、実際に使える返し方を1〜2文で提示する。「あなたのことを見てる、ちゃんと分かってる、ここにいる」という気持ちが自然に伝わる言葉にすること。タメ口で、句読点少なめで、絵文字なしの自然体。そのままLINEにコピペして送れる文体で。"
}
