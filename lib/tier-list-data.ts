...
export const PRESET_TIER_LISTS: PresetTierList[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { mbtiType: "INTP", tier: "1", comment: "第1位は、ヤバすぎて運営に動画を消されるかもしれないので、私の制作したウェブサイトで公開しています。プロフィールのリンクから確認してください。", webAnswer: "倫理観すら「興味深い研究対象」として扱う、同情心ゼロの真性サイコパスだから。" },
    ],
  },
  {
    id: "rich_potential",
    ...
    entries: [
      ...
      { mbtiType: "ESTJ", tier: "1", comment: "第1位は、具体的な年収がヤバすぎて運営に動画を消されるかもしれないので、私の制作したウェブサイトで公開しています。プロフィールのリンクから確認してください。", webAnswer: "感情に流されない圧倒的な現実主義で、お金を生み出す最強のシステムを作り上げるから。" },
    ],
  },
  {
    id: "cheating_tendency",
    title: "浮気しやすいランキング",
    tiktokCaption: "絶対に付き合ってはいけない浮気性MBTI💔 あなたの恋人は大丈夫？\n\n#MBTI #MBTI診断 #16タイプ診断 #浮気 #恋愛 #性格診断",
    videoType: "top5",
    entries: [
      ...
      { mbtiType: "ESFP", tier: "1", comment: "第1位は、ヤバすぎて運営に動画を消されるかもしれないので、私の制作したウェブサイトで公開しています。プロフィールのリンクから確認してください。", webAnswer: "誘惑に弱すぎる上に「今が楽しければいい」という本能だけで生きている生粋のパリピだから。" },
    ],
  },
];
